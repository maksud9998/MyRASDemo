...
public class CarListAdapter extends RecyclerView.Adapter<CarListAdapter.MyViewHolder>{
    ...
    public CarListAdapter(Context contextActivity, ArrayList<CarHelperClass> list, Context contextCar, String start_date, String start_time, String end_date, String end_time) {
//        public CarListAdapter(Context contextActivity, ArrayList<CarHelperClass> list, Context contextCar) {
